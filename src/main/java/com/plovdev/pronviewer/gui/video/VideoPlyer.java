...
import com.plovdev.pronviewer.utility.Sharer;
...
public class VideoPlyer extends StackPane {
    ...
    public VideoPlyer(Media media, String source, String title) {
        ...
        volume.valueProperty().addListener((p1,p2,p3) -> {
            mediaPlayer.setVolume(p3.doubleValue());
        });
        ...
        rates.setValue(1.0);
        rates.valueProperty().addListener((p1,p2,p3) -> {
            mediaPlayer.setRate(p3);
        });
        rates.focusedProperty().addListener(e -> rates.requestFocus());

        HBox top = new HBox(volume, hReg(), rates, getShareButton(source, title));
        ...
        // Показ панели при наведении мыши
    ...
    private Button getShareButton(String s, String t) {
        ...
        shareButton.setOnAction(e -> Sharer.share(s, t));
