...
import com.plovdev.pronviewer.gui.video.DownloadedVideoPlayerPane;
import com.plovdev.pronviewer.utility.DialogShower;
...
public class DownloadedVideoCard extends VideoCard {
    ...
    public Pane display() {
        ...
        ImageView view = new ImageView(new Image(Objects.requireNonNull(getClass().getResourceAsStream("/com/plovdev/pronviewer/download.png"))));
